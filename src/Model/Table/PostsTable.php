 ...
 * @property \App\Model\Table\PostAuthorsTable&\Cake\ORM\Association\BelongsTo $PostAuthors
 *
...
class PostsTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['post_author_id'], 'PostAuthors'));
