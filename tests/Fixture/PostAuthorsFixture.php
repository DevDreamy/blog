...
class PostAuthorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'avatar' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-05-27 14:20:15',
                'modified' => '2022-05-27 14:20:15',
            ],
        ];
        parent::init();
    }
